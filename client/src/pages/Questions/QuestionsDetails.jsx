    ...
    const handlePostCom = (e, commentLength) =>{
        ...
        if(User === null){
            ...
            if(Comment === ''){
                ...
                dispatch(postComment({ id, noOfComments: commentLength + 1, commentBody: comment, userCommented: User.result.name, userId: User.result._id }))
                setShow(!show)
            }
        }
    }
                            ...
                            <div key={question._id}>
                                ...
                                <section className='comments'>
                                    <div className="comment">
                                        <section>
                                        <DisplayQComment key={question._id} question={question} handlePostCom={handlePostCom}/>
                                       </section>
                                    </div>
